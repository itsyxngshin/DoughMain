    ...
    <div class="top-0 left-0 w-full h-auto bg-white shadow-lg bg-cover bg-center bg-no-repeat items-center px-0 " >
        ...
        <div class="px-8 pb-8">
            ...
            <form wire:submit.prevent="store">
                ...
                <input type="hidden" wire:model="shop_id" value="2">
                ...
                <div class="grid grid-cols-2 ml-5 flex-col gap-20 p-3 pt-0">
                    ...
                    <div>
                        <div>
                            ...
                            <input type="text" wire:model="product_name" class="border border-gray-300 mt-2 my-3 px-2 py-1 w-[100%] rounded" placeholder="e.g. Pandesal" required>
                        </div>
                        ...
                        <div x-data="{ text: '', maxChars: 300 }">
                            ...
                            <textarea 
                                x-model="text" wire:model="product_description"
...
<div x-data="fileUpload" class="w-full w-md mx-auto">
    ...
    <input type="file" wire:model="product_image" x-ref="fileInput" hidden accept="image/*" @change="previewImage">
</div>
                    </div>
                    ...
                    <div>
                        <div>
                            ...
                            <select name="category" wire:model="category_id" class="border border-gray-300 mt-2 my-3 px-2 py-1 w-[100%] rounded" id="productCategory">
                        ...
                        <div class="grid grid-cols-2 flex gap-5">
                            <div class="flex gap-3 w-full items-center">
                                ...
                                <select name="status" wire:model="product_status" class="border border-gray-300 mt-2 my-3 ml-2 px-2 py-1 w-[100%] rounded" id="productStatus">
                        ...
                        <div class="grid grid-cols-2 flex gap-5">
                            <div class="flex gap-3 w-full items-center">
                                ...
                                <input type="number" wire:model="quantity" class="border border-gray-300 mt-2 my-3 px-2 py-1 w-[100%] rounded" min="1" value="1">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end pr-11">
                    <button type="button" class="px-6 py-1 bg-transparent text-[#51331b] hover:underline rounded font-regular text-sm" @click="window.location.href='{{ route('productmanagement') }}'">Discard</button>
                    <button type="submit" class="px-6 py-1 bg-[#51331b] text-white hover:bg-white border border-[#51331b] hover:text-[#51331b] rounded font-regular text-sm">Create</button>
                </div>
            </form>

...
<div class="p-6 w-auto overflow-hidden h-screen pt-20">
    <div class="bg-white shadow-lg bg-cover mt-3 bg-center bg-no-repeat items-center" >
          ...
          <div class="pl-12 pr-12  flex gap-3 grid-col-[30%_100%]">
                          ...
                          <tbody>
                              @foreach($reviews as $review)
                                  <tr>
                                      ...
                                      <td class="p-1"><span class="badge @if($review->rating >= 4) bg-success @elseif($review->rating >= 3) bg-warning @else bg-danger @endif">{{ $review->rating ?? 'N/A'}}</span></td>

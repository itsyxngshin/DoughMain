    ...
    <div x-show="open" x-cloak wire:ignore.self class="fixed inset-0 bg-gray-500 bg-opacity-50 z-40 flex items-center justify-center">
        <div class="bg-white p-5 rounded shadow-md w-1/3 z-50">
            ...
            <div class="mt-4 flex justify-end gap-2">
                ...
                <button wire:click="deleteProduct"  @click="open = false; setTimeout(() => { window.location.href = '{{ route('productmanagement') }}'; }, 500);" class="bg-red-500 text-white px-4 py-2 rounded">Delete Product</button>
            </div>
        </div>
    </div>
